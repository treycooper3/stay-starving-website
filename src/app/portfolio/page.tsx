...
export const metadata: Metadata = {
  ...
  description:
    "Explore all divisions: LuxCor AI (6+ projects), Trey Cooper Realty (3 houses sold), KayphoriaX (7 NYFW seasons), The Boardroom (free courses), Stay Starving Media, C3 Properties, and more.",
